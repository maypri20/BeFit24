...
# =========================
st.set_page_config(
    page_title="FitTrack360 - Body Composition & Recommendations",
    page_icon="💪",
    layout="wide"
)

st.title("💪 FitTrack360 — Body Composition & Personalized Recommendations")
st.caption("Analyze your profile using real data and similarity-based metrics (Gower distance).")
...
# --- Nutrition Info ---
st.sidebar.subheader("🍽️ Nutrition Intake (per day)")
...
if run_button:
    ...
    if goal == "Lose Weight":
        ...
        recs.append("🏋️ Focus on progressive overload strength training (3–5x/week).")

    elif goal == "Maintain Weight":
        recs.append("⚖️ Aim for a calorie balance near zero — steady intake & output.")
        ...
        recs.append("🧘‍♀️ Include flexibility and recovery days.")
    ...
    if results["cal_balance"] < -300:
        ...
        recs.append("⚖️ You’re in a calorie surplus — good for muscle gain, monitor fat.")
